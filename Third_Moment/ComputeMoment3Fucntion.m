...
% 30.08.20 Asaf Abas.
function [f] = ComputeMoment3Fucntion(rho, signal, sigma, empricalMoment,...
                                     projection, pOutlier, CovOutlier, indeces, sigmaScalar)
%% Get Rho and x
...
[M3] = ComuteM3Analytical(rho, signal, sigmaScalar,indeces);

%% Compute the diffrence
f  = [M1 ; M2;M3 ] - empricalMoment; 
% f = [M3] - empricalMoment;
end