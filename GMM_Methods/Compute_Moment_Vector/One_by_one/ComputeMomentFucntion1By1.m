...
% observations.
% 3.09.2.0 Asaf Abas.
function [fs] = ComputeMomentFucntion1By1(rho, signal, observations, sigma, projection,...
                                                        pOutlier, sigmaOutlier)
%% General params
...
fOutputLength = length(M1) + length(M2);
